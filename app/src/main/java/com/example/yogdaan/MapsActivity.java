...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap = googleMap;
            ...
            ff.collection("UserInformation").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                @Override
        ...
        mMap.addMarker(new MarkerOptions().position(sydney).title("This is your Current Location"));
